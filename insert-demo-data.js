...
async function insertDemoData() {
  try {
    ...
    // Utilisateurs
    const users = [
      ['admin@arbitrage.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin', 'Admin', 'Système', '0600000000'],
      ['arbitre1@arbitrage.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'arbitre', 'Jean', 'Dupont', '0601234567'],
      ['client1@email.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'client', 'Marie', 'Martin', '0607654321'],
      ['client2@email.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'client', 'Ahmed', 'Benali', '0612345678']
    ];
    ...
    // Formations
    const formations = [
      ['Formation Arbitrage Commercial', 'Maîtrisez les techniques d\'arbitrage pour les litiges commerciaux. Formation complète avec cas pratiques.', '3 jours', 'Juristes, Avocats, Médiateurs', 2500],
      ['Médiation et Négociation', 'Apprenez les méthodes de résolution amiable des conflits. Techniques de communication et de négociation.', '2 jours', 'Professionnels RH, Managers', 1800],
      ['Arbitrage International', 'Spécialisez-vous dans l\'arbitrage transfrontalier. Droit international et procédures spécialisées.', '5 jours', 'Experts juridiques, Avocats internationaux', 4200],
      ['Gestion des Conflits en Entreprise', 'Formation pratique pour gérer les conflits internes et améliorer le climat social.', '1 jour', 'DRH, Managers, Chefs d\'équipe', 950]
    ];
    ...
    // Services
    const services = [
      ['Arbitrage Commercial', 'Résolution rapide et efficace des litiges commerciaux entre entreprises', 'arbitrage', 1500],
      ['Médiation Familiale', 'Accompagnement dans la résolution des conflits familiaux (divorce, succession)', 'mediation', 800],
      ['Arbitrage Immobilier', 'Règlement des différends liés aux transactions immobilières', 'arbitrage', 1200],
      ['Médiation du Travail', 'Résolution des conflits entre employeurs et salariés', 'mediation', 600],
      ['Arbitrage International', 'Arbitrage pour les litiges transfrontaliers', 'arbitrage', 3000]
    ];
    ...
    const temoignages = [
      ...
      ['Lemoine', 'Pierre', 'pierre.lemoine@email.com', 'Médiation familiale très bien menée. L\'arbitre était impartial et nous a aidés à trouver un accord équitable.', 4, 'mediation', 'approuve'],
      ['Khalil', 'Fatima', 'fatima.khalil@email.com', 'Formation sur la gestion des conflits très utile. J\'ai pu appliquer les techniques apprises dès mon retour au bureau.', 5, 'formation', 'approuve']
    ];
